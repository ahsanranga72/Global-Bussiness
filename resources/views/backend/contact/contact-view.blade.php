  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Contact Manage</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <section class="col-sm-12">
           ...
           @foreach($alldata as $key => $contact)
                <tr>
                  ...
                  <td>{{ $contact->twtter}}</td>
                  <td>{{ $contact->youtube}}</td>
                  <td>{{ $contact->linkedin}}</td>

                  <td>
                  	<a href="{{ route('contacts.edit',$contact->id)}}" class="btn btn-sm btn-primary" title="edit"><i class="fa fa-edit"></i></a>
                  	<a href="{{ route('contacts.delete',$contact->id)}}" id="delete" class="btn btn-sm btn-danger" title="delete"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>
            @endforeach
