        ...
        <div class="row">
          <section class="col-sm-12">
           ...
           @foreach($alldata as $key => $comminicate)
                <tr>
                  <td>{{$key+1}}</td>
                  <td>{{ $comminicate->f_name}}</td>
                  <td>{{ $comminicate->l_name}}</td>
                  <td>{{ $comminicate->email}}</td>
                  <td>{{ $comminicate->mobile_no}}</td>
                  <td>{{ $comminicate->country}}</td>
                  <td>{{ $comminicate->city}}</td>
                  <td>{{ $comminicate->msg}}</td>
                  <td>
