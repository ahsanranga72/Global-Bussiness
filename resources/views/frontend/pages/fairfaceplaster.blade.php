                            ...
                            <div class="pro-details-image mb-60">
                                <div class="pro-details-big-image">
                                    <div class="tab-content">
                                        <div role="tabpanel" class="tab-pane fade in active" id="pro-1">
                                            <a href="{{asset('frontend/assets/images/single-property/big/Fair-Face-Plaster01.jpg')}}" data-lightbox="image-1" data-title="Sheltek Properties - 1">
                                                <img src="{{asset('frontend/assets/images/single-property/big/Fair-Face-Plaster01.jpg')}}" alt="Fair Face Plaster In Bangladesh">
                                            </a>
                                        </div>
                                        <div role="tabpanel" class="tab-pane fade" id="pro-2">
                                            <a href="{{asset('frontend/assets/images/single-property/big/Fair-Face-Plaster02.jpg')}}" data-lightbox="image-1" data-title="Sheltek Properties - 2">
                                                <img src="{{asset('frontend/assets/images/single-property/big/Fair-Face-Plaster02.jpg')}}" alt="Fair Face Plaster In Bangladesh">
                                            </a>
                                        </div>
                                        <div role="tabpanel" class="tab-pane fade" id="pro-3">
                                            <a href="{{asset('frontend/assets/images/single-property/big/Fair-Face-Plaster03.jpg')}}" data-lightbox="image-1" data-title="Sheltek Properties - 3">
                                                <img src="{{asset('frontend/assets/images/single-property/big/Fair-Face-Plaster03.jpg')}}" alt="Fair Face Plaster In Bangladesh">
                                            </a>
                                        </div>
                                        <div role="tabpanel" class="tab-pane fade" id="pro-4">
                                            <a href="{{asset('frontend/assets/images/single-property/big/Fair-Face-Plaster04.jpg')}}" data-lightbox="image-1" data-title="Sheltek Properties - 4">
                                                <img src="{{asset('frontend/assets/images/single-property/big/Fair-Face-Plaster04.jpg')}}" alt="Fair Face Plaster In Bangladesh">
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                <div class="pro-details-carousel">
                                    <div class="pro-details-item">
                                        <a href="#pro-1" data-toggle="tab"><img src="{{asset('frontend/assets/images/single-property/small/Fair-Face-Plaster01.jpg')}}" alt="Fair Face Plaster In Bangladesh"></a>
                                    </div>
                                    <div class="pro-details-item">
                                        <a href="#pro-2" data-toggle="tab">
                                            <img src="{{asset('frontend/assets/images/single-property/small/Fair-Face-Plaster02.jpg')}}" alt="Fair Face Plaster In Bangladesh">                
                                        </a>
                                    </div>
                                    <div class="pro-details-item">
                                        <a href="#pro-3" data-toggle="tab">
                                            <img src="{{asset('frontend/assets/images/single-property/small/Fair-Face-Plaster03.jpg')}}" alt="Fair Face Plaster In Bangladesh">                
                                        </a>
                                    </div>
                                    <div class="pro-details-item">
                                        <a href="#pro-4" data-toggle="tab">
                                            <img src="{{asset('frontend/assets/images/single-property/small/Fair-Face-Plaster04.jpg')}}" alt="Fair Face Plaster In Bangladesh">                
                                        </a>
                                    </div>
                                </div>                           
                            </div>
